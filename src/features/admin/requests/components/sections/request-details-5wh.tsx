  ...
  return (
    <section>
      ...
      <div className="space-y-3">
        <div>
          <Text style="label-sm" className="text-disable mb-1">Who</Text>
          <Text style="paragraph-sm">{request.who || "Not specified"}</Text>
        </div>
        <div>
          <Text style="label-sm" className="text-disable mb-1">What</Text>
          <Text style="paragraph-sm">{request.what || "Not specified"}</Text>
        </div>
        <div>
          <Text style="label-sm" className="text-disable mb-1">When</Text>
          <Text style="paragraph-sm">{request.when || "Not specified"}</Text>
        </div>
        <div>
          <Text style="label-sm" className="text-disable mb-1">Where</Text>
          <Text style="paragraph-sm">{request.where || "Not specified"}</Text>
        </div>
        <div>
          <Text style="label-sm" className="text-disable mb-1">Why</Text>
          <Text style="paragraph-sm">{request.why || "Not specified"}</Text>
        </div>
        <div>
          <Text style="label-sm" className="text-disable mb-1">How</Text>
          <Text style="paragraph-sm">{request.how || "Not specified"}</Text>
        </div>
        {request.info && (
          <div>
            <Text style="label-sm" className="text-disable mb-1">Additional Information</Text>
