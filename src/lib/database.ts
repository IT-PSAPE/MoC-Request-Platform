...
const RequestTable = {
    list: async (supabase: SupabaseClient): Promise<FetchRequest[]> => {
...
export { EquipmentTable, SongTable, VenueTable, RequestSongTable, RequestItemTable, RequestTable, StatusTable, PriorityTable, RequestTypeTable };